...
export const StaffEdit = () => {
      ...
      try {
        ...
        if (res.success) {
          ...
          setFormData({
            ...
            salary: s.salary !== undefined ? s.salary : '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        toast.success(`Staff member ${res.data.fullName} updated successfully`);
        navigate(`/staff/${id}`);
      }
    } catch (err) {
  ...
  if (loading) {
    return <PageLoader message="Loading staff record for editing..." />;
  }
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Edit Staff Profile</h1>
            <p className="text-xs text-slate-500">Update employment details, department, or status</p>
          </div>
        </div>
      </div>
